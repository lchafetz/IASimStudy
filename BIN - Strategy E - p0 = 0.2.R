...
n<-962 # sample size for assumed p_0=0.20 
D<-166 # number of expected events for assumed p_0=0.20
...
results_0.2_E<-data.frame(rbind(r1,r2,r3,r4,r5,r6))
rownames(results_0.2_E)<-c("P_1","N_1","D_1","P_2","N_2","D_2")
results_0.2_E
save(results_0.2_E, file="bin_0.2_E.RData")
