...
#   Low censoring, control hazard well estimated  #
###################################################
...
n=306 #sample size for assumed beta_0 of -1 (change sample size depending on phi and assumed beta_0)
...
save(mod.half.E, file="E.half.low.well.RData")
...
save(mod.half.SS, file="SS.half.low.well.RData")
...
save(mod.final.E, file="E.final.low.well.RData")
...
save(mod.final.SS, file="SS.final.low.well.RData")
...
results.low.well<-data.frame(rbind(r1,r2,r3,r4,r5,r6,r7,r8))
rownames(results.low.well)<-c("P1","T1","D1","N1","P2","T2","D2","N2")

save(results.low.well,file="results.low.well.RData")
results.low.well
