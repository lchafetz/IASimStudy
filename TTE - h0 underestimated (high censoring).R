...
#   High censoring, control hazard underestimated #
###################################################
...
n=1330 #sample size for assumed beta_0 of -1 (change sample size depending on phi and assumed beta_0)
...
save(mod.half.E, file="E.half.high.under.RData")
...
save(mod.half.SS, file="SS.half.high.under.RData")
...
save(mod.final.E, file="E.final.high.under.RData")
...
save(mod.final.SS, file="SS.final.high.under.RData")
...
results.high.under<-data.frame(rbind(r1,r2,r3,r4,r5,r6,r7,r8))
rownames(results.high.under)<-c("P1","T1","D1","N1","P2","T2","D2","N2")

save(results.high.under,file="results.high.under.RData")
results.high.under
